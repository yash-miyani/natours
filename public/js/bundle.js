...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, email, password, passwordConfrim) {
    var res;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWFzaDA1MjEiLCJhIjoiY2xyMnl5cDl1MDd3ZTJrcjFuNTV1cmsweCJ9.TWdib5MHBZZi2Fa398-88Q';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/yash0521/clr2z44xc01bf01qu595kbku9',
    // style URL
    scrollZoom: false
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51OacrMSCxDyBjaYKRAJRo1Qll4MWY76WzjXjHJa5QGZcdELHlbohUTkFFLiN4w9awp635KjmLQwpvHSpriuauvEE00FUXl39DZ');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfrim = document.getElementById('confirmPassword').value;
